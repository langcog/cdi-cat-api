...
write.csv(seq0, file="test_sequences/fr_CAT_test_theta0_au.revoir.csv", row.names = F) # Theta_1 = .022 (25 items)
write.csv(seq1, file="test_sequences/fr_CAT_test_theta1_construire.csv", row.names = F) # Theta_1 = 1.11 (40 items)
```
